FamiTone2 audio library v1.11 by Shiru 09'14
...
feature. Unlike music, you can use most of FamiTracker features for
effects, except the sweep. Every effect should be finished with silence,
and effect C00 on the last row of the effect. After you have made all
the effects, export them as NSF file and use nsf2data converter
(nsf2data sounds.nsf). You'll get *.asm file with the effects data.
...
defines in the beginning of the file. You can change RAM and zero page
...
After The Rain                7847      6059      6315      4552
Danger Streets                4825      4840      5522      4171
Lan Master (4 sub songs)     12373     10097     12072      7681
Lawn Mower (5 sub songs)      9248      6281      8594      4550
...
%0nnnnnn0 is a note (0 rest note, 1..60 are octaves 1-5)
...
1..16 range. There is no instruments and octaves in the DPCM channel,
note codes are in 1..12 range.
...
$01..$7f is a number of frames to skip before reading next block of data
         minus $10 ($10 if the next frame is not empty)
...
jsr (FamiTracker), Gradualore (plug-in system for FamiTracker),
rainwarrior (built-in text export in FamiTracker), Memblers (library's
name), kevtris, Gil, B00daW, ManicGenius, thefox, UncleSporky, kulor,
MovieMovies1, and NesDev community.
